...
LIBRARY: AWS Boto 3  
PURPOSE:
Implements a drop video transcoder to convert media files by dragging and dropping them
from desktop.    
SOURCE: https://github.com/boto3/boto3-sample
...
class AutoTranscode(object):
    """
    Main transcoder class, which exposes a ``run`` method. 
	It watches for new files, 
	2. uploads them to S3,
	3. converts them using Elastic Transcoder and ..
	4. downloads the output from S3 back to local storage.
    """
    # IAM role policies .
    basic_role_policy = {
        'Statement': [
    ...
    # SQS queue needs a policy to allow the SNS topic to post to it.
    ...
    # Default configuration which must be edited.
    empty_config_data = {
        'unconverted_directory': "<LOCAL DIRECTORY FOR INPUT FILES>",
        'converted_directory': "<LOCAL DIRECTORY FOR OUTPUT FILES>",
        'in_bucket_name': "<INPUT BUCKET NAME>",
        'out_bucket_name': "<OUTPUT BUCKET NAME>",
    ...
    def create_empty_config(cls, config_filepath):
        ...
        must edit the file before application can work.
        """
    ...
    def ensure_local_setup(self):
        ...
        the directories exist and aren't the same.
        """
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Finito! Bail out without dumping a traceback.
        sys.exit(0)