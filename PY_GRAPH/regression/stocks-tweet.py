...
#as positive or negative. If the majority of tweets  collected are positive
...
#Step 6 In   function, build neural network model using Keras, train it, then have it predict the price 
