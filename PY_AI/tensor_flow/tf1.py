...
# [[0,0.1,0.3...]
#  [0 .....     ]
#       ....   ]]  must flatten data to list of length 784 for input layer to neural network;
...
# Then add intermediary, hidden layer of 128 (inputs go to hidden layer, hidden layer to outputs) to find patterns
